...
# Funciones para buscar datos de forma paralela
...
def calcular_top_5_comunidad(comunidad):
    ...
    # Lanzamos peticiones simultáneas
    with concurrent.futures.ThreadPoolExecutor(max_workers=10) as executor:
        ...
        for futuro in concurrent.futures.as_completed(futuros):
            ...
            if res:
                ...
                # ¡Solo 15 horas para que la RAM del Arduino no explote!
    ...
    for index, spot in enumerate(top_5):
        ...
        # Empaquetamos todo el CSV (8 variables exactas por línea)
